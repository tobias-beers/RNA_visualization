...
"""
This code has been copied from https://github.com/epierson9/ZIFA/blob/master/ZIFA/ZIFA.py.
It does not belong to me, if you are interested in this code or in the ZIFA model, visit the github of 'epierson9'.
